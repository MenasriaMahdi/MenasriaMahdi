...
### Full-Stack Developer · System Design · DevOps · Networking
...
**Real projects · System designs · Case studies · Experiments**
...
`System Design` · `Backend Architecture` · `DevOps` · `Cloud` · `Networking`

I'm continuously expanding from **writing applications** to understanding the **systems and infrastructure that make them reliable in production**.
